...
// stdlib-only (ed25519 or ECDSA P-256, PKCS#8 keys), adding authenticity on top
// of the integrity digest the evidence document already carries.
package attest
...
func LoadSigner(pemPath string) (*Signer, error) {
	...
	case *ecdsa.PrivateKey:
		...
		s.spki, err = x509.MarshalPKIXPublicKey(k.Public())
	default:
		return nil, fmt.Errorf("unsupported key type %T; use ed25519 or ECDSA P-256", key)
	}
	if err != nil {
